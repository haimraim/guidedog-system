    ...
    return (
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8 mb-6">
          <h2 className="text-3xl font-bold text-neutral-800 mb-4">영상 시청실 📹</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <button
              ...
              className="bg-gradient-to-br from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 border-2 border-primary-300 rounded-xl p-8 text-left transition-all transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-primary-500 focus:ring-offset-2"
            ...
            <button
              ...
              className="bg-gradient-to-br from-green-50 to-green-100 hover:from-green-100 hover:to-green-200 border-2 border-success-300 rounded-xl p-8 text-left transition-all transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-success-500 focus:ring-offset-2"
