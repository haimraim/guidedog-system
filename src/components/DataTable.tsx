...
export const DataTable: React.FC = () => {
  ...
  return (
    <section className="bg-white p-6 rounded-lg shadow-md" aria-labelledby="table-heading">
          ...
          <table className="w-full border-collapse border border-neutral-300">
            ...
            <thead>
              <tr className="bg-neutral-100">
                <th scope="col" className="border border-neutral-300 px-4 py-3 text-left">
                  번호
                </th>
                <th scope="col" className="border border-neutral-300 px-4 py-3 text-left">
                  견명
            ...
            <tbody>
              {data.map((item, index) => (
                ...
                >
                  <td className="border border-neutral-300 px-4 py-3">{index + 1}</td>
                  <td className="border border-neutral-300 px-4 py-3 font-semibold">
                    {item.guideDog.name || '-'}
                  </td>
                  ...
                  <td className="border border-neutral-300 px-4 py-3 text-center">
                    <button
                      ...
                      className="px-3 py-1 bg-error-600 text-white rounded hover:bg-error-700 focus:ring-4 focus:ring-error-300"
                    >
                      삭제
                    </button>
                  </td>
      ...
      {/* 테이블 사용 안내 */}
      {data.length > 0 && (
        <div className="mt-4 p-4 bg-neutral-50 border border-neutral-300 rounded">
