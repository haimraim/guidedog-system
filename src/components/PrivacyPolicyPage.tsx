  ...
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
      ...
      <div className="space-y-6 text-gray-700">
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">1. 처리하는 개인정보 항목</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">2. 개인정보의 보유 및 이용기간</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">3. 개인정보의 처리 목적</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">5. 개인정보의 기술적 보안조치</h2>
          <p>웹사이트는 암호화, 백신, 방화벽을 설치하여 개인정보를 보호하고 있습니다.</p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">6. 개인정보의 삭제</h2>
